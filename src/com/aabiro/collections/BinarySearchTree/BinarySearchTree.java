...
//O(logN) for average case of all methods! (if balanced)
...
public class BinarySearchTree<T extends Comparable<T>> implements Tree<T> {
    ...
    //helper methods - private, cannot be called from outside
    ...
    private Node<T> delete(Node<T> node, T data) {
        ...
        if (data.compareTo(node.getData()) < 0) {
            ...
            //predecessor is the max value of the left subtree
